...
void Cplayer::render(HDC hdc)
{
	...
	else if (_state == STATE::DIE)
	{
		...
		case STATE::ATTBOWIDLE:
			...
			break;
		case STATE::IDLE:
			//IMAGE->findImage("∞»±‚")->alphaFrameRender(hdc, _player.playerRect.left - imageLeftCorrection, _player.playerRect.top - imageTopCorrection, 1, _moveDirection, 100);
			ZORDER->ZorderAlphaFrameRender(IMAGE->findImage("∞»±‚"), ZUNIT, RecCenY(_player.playerRect), _player.playerRect.left - imageLeftCorrection, _player.playerRect.top - imageTopCorrection, 1, _moveDirection, _alpha);
			break;
		case STATE::WALK:
	...
	//	{
	//	case STATE::IDLE:
	//		//IMAGE->frameRender("∞»±‚", hdc, _player.playerRect.left - imageLeftCorrection, _player.playerRect.top - imageTopCorrection, 1, _moveDirection);
	//		ZORDER->ZorderFrameRender(_walk_img, ZUNIT, RecCenY(_player.playerRect), _player.playerRect.left - imageLeftCorrection, _player.playerRect.top - imageTopCorrection, 1, _moveDirection);
	//		break;
	//	case STATE::WALK:
...
>>>>>>> origin/ÏÉàÎ°úÌÉúÏñ¥ÎÇòÏûêÎ∏åÎûúÏπò
	{
...
{
	_alpha = 255;
	_walk_img = IMAGE->addFrameImage("∞»±‚", "images/Player/∞»±‚º¯º≠ºˆ¡§.bmp", 300, 800, 3, 8, true, RGB(255, 0, 255));
	_bowWalk_img = IMAGE->addFrameImage("»∞∞»±‚", "images/Player/»∞.bmp", 300, 800, 3, 8, true, RGB(255, 0, 255));
	_run_img = IMAGE->addFrameImage("¥ﬁ∏Æ±‚", "images/Player/¥ﬁ∏Æ±‚ºˆ¡§øﬁπﬂ∏’¿˙.bmp", 400, 800, 4, 8, true, RGB(255, 0, 255));
	_dash_img = IMAGE->addFrameImage("¥ÎΩ¨", "images/Player/¥ÎΩ¨ºˆ¡§.bmp", 600, 800, 6, 8, true, RGB(255, 0, 255));
	IMAGE->addFrameImage("¥ÎΩ¨¿Ã∆Â∆Æ", "images/Player/¥ÎΩ¨ºˆ¡§.bmp", 600, 800, 6, 8, true, RGB(255, 0, 255));
	_attStaff_img = IMAGE->addFrameImage("±‚∫ª∞¯∞›", "images/Player/±‚∫ª∞¯∞›.bmp", 600, 800, 6, 8, true, RGB(255, 0, 255));
	_knockBack_img = IMAGE->addFrameImage("≥ÀπÈ", "images/Player/««∞›ºˆ¡§.bmp", 300, 800, 3, 8, true, RGB(255, 0, 255));
	_die_img = IMAGE->addFrameImage("¡◊±‚", "images/Player/ªÁ∏¡.bmp", 100, 100, 1, 1, true, RGB(255, 0, 255));
	_chargeAtt_img = IMAGE->addFrameImage("√≠¡ˆº¶", "images/Player/Ω∫≈¬«¡_√≠¡ˆº¶ºˆ¡§.bmp", 300, 800, 3, 8, true);
...
void Cplayer::renderDashEffecct(HDC hdc)
{
	...
	{
		ZORDER->ZorderAlphaFrameRender(IMAGE->findImage("¥ÎΩ¨¿Ã∆Â∆Æ"), ZUNIT, RecCenY(_player.playerRect) - 1, _iterDashEffect->x, _iterDashEffect->y, _iterDashEffect->dashFrameX, _iterDashEffect->direction, _iterDashEffect->dashAlpha);
...
{
	// ZORDER->ZorderRotateFrameRender(¿ÃπÃ¡ˆ, z, πŸ≈“±‚¡ÿ∞™, ºæ≈Õx, ºæ≈Õy, ∞¢µµ, «¡∑π¿”x, «¡∑π¿”y);
