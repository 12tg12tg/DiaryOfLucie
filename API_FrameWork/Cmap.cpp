...
Cmap::Cmap()
{
	...
	_collisionMap =IMAGE->addImage("95픽셀", "images/map/!m95.bmp", WINSIZEX, WINSIZEY, true, RGB(255, 0, 255));
...
Cmap2::Cmap2()
{
	...
	_collisionMap = IMAGE->addImage("57픽셀", "images/map/!m57.bmp", WINSIZEX, WINSIZEY, true, RGB(255, 0, 255));
...
Cmap3::Cmap3()
{
	...
	_collisionMap = IMAGE->addImage("104픽셀", "images/map/!m104.bmp", WINSIZEX, WINSIZEY, true, RGB(255, 0, 255));
...
Cmap4::Cmap4()
{
	...
	_collisionMap = IMAGE->addImage("105픽셀", "images/map/!m105.bmp", WINSIZEX, WINSIZEY, true, RGB(255, 0, 255));
...
Cmap5::Cmap5()
{
	...
	_collisionMap = IMAGE->addImage("115픽셀", "images/map/!m115.bmp", WINSIZEX, WINSIZEY, true, RGB(255, 0, 255));
