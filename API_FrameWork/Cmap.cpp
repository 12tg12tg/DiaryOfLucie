...
moruMap::moruMap()
{
	IMAGE->addImage("¸ğ·ç¹æ¹è°æ", "images/map/moruMap.bmp", 1008, 672, true, RGB(255, 0, 255));
	_collisionMap = IMAGE->addImage("¸ğ·ç¹æÇÈ¼¿", "images/map/!mmoruMap.bmp", 1008, 672, true, RGB(255, 0, 255));
	IMAGE->addImage("¸ğ·ç¹æ°¡¸²", "images/map/ParmoruMap.bmp", 1008, 672, true, RGB(255, 0, 255));
...
void moruMap::render()
{
	ZORDER->ZorderRender(IMAGE->findImage("¸ğ·ç¹æ¹è°æ"), ZFLOORMAP, WINSIZEX, 0, 0);
	ZORDER->ZorderRender(IMAGE->findImage("¸ğ·ç¹æ°¡¸²"), ZABOVEMAP, WINSIZEX, 0, 0);
	if (_isDebug)ZORDER->ZorderRender(IMAGE->findImage("¸ğ·ç¹æÇÈ¼¿"), ZCOLMAP, WINSIZEX, 0, 0);
	if (isleftRoom)
	{
		if (_isDebug)ZORDER->ZorderRectangle(_door[0].Door, ZEFFECT1);
		ZORDER->ZorderAniRender(_portalImage, ZEFFECT1, 400, -90, 300, _portal);
...
nextStage::nextStage()
{
	IMAGE->addImage("´ÙÀ½Ãş¹è°æ", "images/map/nextStage.bmp", 1008, 672, true, RGB(255, 0, 255));
	_collisionMap = IMAGE->addImage("´ÙÀ½ÃşÇÈ¼¿", "images/map/!mnextStage.bmp", 1008, 672, true, RGB(255, 0, 255));
	IMAGE->addImage("´ÙÀ½Ãş°¡¸²", "images/map/ParnextStage.bmp", 1008, 672, true, RGB(255, 0, 255));
	IMAGE->addImage("¸¶¹ıÁø", "images/map/portal.bmp", 162, 174, true, RGB(255, 0, 255));
...
{
	ZORDER->ZorderAlphaRender(IMAGE->findImage("¸¶¹ıÁø"), ZEFFECT1, WINSIZEY, 423, 279, 150);
	ZORDER->ZorderRender(IMAGE->findImage("´ÙÀ½Ãş¹è°æ"), ZFLOORMAP, WINSIZEX, 0, 0);
	ZORDER->ZorderRender(IMAGE->findImage("´ÙÀ½Ãş°¡¸²"), ZABOVEMAP, WINSIZEX, 0, 0);
	if (_isDebug)ZORDER->ZorderRender(IMAGE->findImage("´ÙÀ½ÃşÇÈ¼¿"), ZCOLMAP, WINSIZEX, 0, 0);
	if (isleftRoom)
	{
		if (_isDebug)ZORDER->ZorderRectangle(_door[0].Door, ZEFFECT1);
		ZORDER->ZorderAniRender(_portalImage, ZEFFECT1, 400, -90, 300, _portal);
...
fountainMap::fountainMap()
{
	...
	IMAGE->addImage("ºĞ¼ö¹æ¹è°æ", "images/map/fountainMap.bmp", 1008, 672, true, RGB(255, 0, 255));
	_collisionMap = IMAGE->addImage("ºĞ¼ö¹æÇÈ¼¿", "images/map/!mfountainMap.bmp", 1008, 672, true, RGB(255, 0, 255));
	IMAGE->addImage("ºĞ¼ö¹æ°¡¸²", "images/map/ParfountainMap.bmp", 1008, 672, true, RGB(255, 0, 255));
...
{
	ZORDER->ZorderRender(IMAGE->findImage("ºĞ¼ö¹æ¹è°æ"), ZFLOORMAP, WINSIZEX, 0, 0);
	ZORDER->ZorderRender(IMAGE->findImage("ºĞ¼ö¹æ°¡¸²"), ZABOVEMAP, WINSIZEX, 0, 0);
	if (_isDebug)ZORDER->ZorderRender(IMAGE->findImage("ºĞ¼ö¹æÇÈ¼¿"), ZCOLMAP, WINSIZEX, 0, 0);
	if (isleftRoom)
	{
		if (_isDebug)ZORDER->ZorderRectangle(_door[0].Door, ZEFFECT1);
		ZORDER->ZorderAniRender(_portalImage, ZEFFECT1, 400, -90, 300, _portal);
