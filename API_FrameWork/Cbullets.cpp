...
10.	CmLongPoisonBullet /	µ¶ÃÑ¾Ë
11.	CmSBoss1Bullet  /	¹öºí , ¸ó½ºÅÍÃÑ¾Ë
12.	CmFBoss1Bullet  /    Åõ¸í,°¡½Ã,°æ°í
13. CmFBoss2Bullet	/	°¡½Ã,°æ°í
14. CmFBoss3Bullet	/	¸ó½ºÅÍÃÑ¾Ë
15. CmTBoss1Bullet	/	ºê·¹½º
16. CmTBoss2Bullet	/	³ª¹«º¸½ºÃÑ¾Ë
17. CmTBoss3Bullet	/	¸ó½ºÅÍÃÑ¾Ë
*/
//////////////////////////////////////////////////////////////
/////	CpMagicBullet!	    	¸¶¹ýÃÑ¾Ë!	//////////////////
//////////////////////////////////////////////////////////////
...
void CmFBoss1Bullet::fire(float x, float y,bool isleft, int plussize)
{
	...
	for (int i = 0; i < 6; i++)
	{
		ZeroMemory(&bullet, sizeof(tagBullet));
		bullet.bulletImage = new  image;
		bullet.bulletImage = IMAGE->addImage("Åõ¸í", "images/bullet_bmp/bubble.bmp", 50, 60 , true, RGB(255, 0, 255));
		bullet.angle = 1.046 * i;
		bullet.speed = 4.0;
		if (isleft)
		{
...
void CmFBoss1Bullet::fire2(float x, float y, int plussize)
{
	tagBullet bullet2;
		...
		ZeroMemory(&bullet2, sizeof(tagBullet));
		bullet2.bulletImage2 = new  image;
		bullet2.bulletImage2 = IMAGE->addImage("°æ°í", "images/bullet_bmp/warning.bmp", 50 , 55 , true, RGB(255, 0, 255));
...
void CmFBoss1Bullet::fire3(float x, float y, int plussize)
{
	tagBullet bullet3;
		...
		bullet3.bulletImage3 = IMAGE->addImage("°¡½Ã", "images/bullet_bmp/niddle.bmp", 50 , 55 , true, RGB(255, 0, 255));
		bullet3.angle = PI / 2;
...
void CmFBoss2Bullet::fire2(float x, float y, int plussize)
{
	...
	ZeroMemory(&bullet2, sizeof(tagBullet));
	bullet2.bulletImage2 = new  image;
		bullet2.bulletImage2 = IMAGE->addImage("°¡½Ã", "images/bullet_bmp/niddle.bmp", 50, 55, true, RGB(255, 0, 255));
...
void CmTBoss2Bullet::fire(float x, float y, float angle, bool isLeft, int plussize)
{
	...
	for (int i = 0; i < 3; i++)
	{
		ZeroMemory(&bullet, sizeof(tagBullet));
		bullet.bulletImage = new  image;
		bullet.bulletImage = IMAGE->addFrameImage("³ª¹«º¸½ºÃÑ¾Ë", "images/bullet_bmp/TBossBullet.bmp", 400, 48, 8, 1, true, RGB(255, 0, 255));
		if (isLeft)
		{
			bullet.omega = 0.0005;
		}
...
void CpSword::fire(float x, float y, float angle, int plussize)
{
	...
	ZeroMemory(&bullet, sizeof(tagBullet));
	bullet.bulletImage = new  image;
	bullet.bulletImage = IMAGE->addImage("°Ë1", "images/bullet_bmp/sword1.bmp", 192,192,true,RGB(255,0,255));
	bullet.angle = angle;
	bullet.rotateangle = angle + PI / 2;
	bullet.speed = 5.0f;
	bullet.x = bullet.fireX = x;
...
void CpSword::fire2(float x, float y, float angle, int plussize)
{
	...
	bullet.bulletImage2 = IMAGE->addImage("°Ë2", "images/bullet_bmp/sword2.bmp", 192, 192, true, RGB(255, 0, 255));
	bullet.angle = angle;
	bullet.rotateangle = angle + PI / 2;
	bullet.speed = 5.0f;
	bullet.x = bullet.fireX = x;
...
void CpSword::fire3(float x, float y, float angle, int plussize)
{
	...
	bullet.bulletImage3 = IMAGE->addImage("°Ë3", "images/bullet_bmp/sword3.bmp", 192, 192,true, RGB(255, 0, 255));
	bullet.angle = angle;
	bullet.rotateangle = angle + PI / 2;
	bullet.speed = 5.0f;
	bullet.x = bullet.fireX = x;
...
void CpSkil_LuckyStar::fire(float x, float y, float angle, int plussize)
{
	...
	for (int i = 0; i < 5; i++)
	{
		ZeroMemory(&bullet, sizeof(tagBullet));
		bullet.bulletImage = new  image;
		bullet.bulletImage = IMAGE->addImage("º°ÃÑ¾Ë", "images/bullet_bmp/skill_ms_star.bmp",12,12, true);
		bullet.plussize = 1 + (double)plussize / bullet.bulletImage->getWidth();
...
void CpSkil_Ice_spear::fire(float x, float y, float angle, int plussize)
{
	...
	ZeroMemory(&bullet, sizeof(tagBullet));
	bullet.bulletImage = new  image;
	bullet.bulletImage = IMAGE->addImage("¾óÀ½È­»ì", "images/bullet_bmp/ice.bmp", 61, 21, true);
	bullet.angle2 = angle;
	bullet.angle = angle;
	bullet.speed = 4.0f;
	bullet.x = bullet.fireX = x;
...
void CpSkil_Ice_spear::fire2(float x, float y, float angle, int plussize)
{
	tagBullet bullet2;
		ZeroMemory(&bullet2, sizeof(tagBullet));
		bullet2.bulletImage2 = new  image;
		bullet2.bulletImage2 = IMAGE->addFrameImage("¾óÀ½Æø¹ß", "images/bullet_bmp/sk_iceSpear.bmp",800, 640,5,4, true, RGB(255, 0, 255));
		bullet2.bulletAni = new animation;
		bullet2.bulletAni = ANIMATION->addNoneKeyAnimation("¾óÀ½Æø¹ß", 20, false, true);
		bullet2.angle2 = 1.049;
		bullet2.angle = 0;
		bullet2.speed = 2.0f;
		bullet2.alpha = 255;
...
void CpSkil_Haste::fire(float x, float y, float angle, int plussize)
{
	...
	ZeroMemory(&bullet, sizeof(tagBullet));
	bullet.bulletImage = new  image;
	bullet.bulletImage = IMAGE->addFrameImage("ÇìÀÌ½ºÆ®", "images/bullet_bmp/sk_haste.bmp", 960,1536, 5, 8, true, RGB(255, 0, 255));
	bullet.bulletAni = new animation;
	bullet.bulletAni = ANIMATION->addNoneKeyAnimation("ÇìÀÌ½ºÆ®", 50, false, true);
	bullet.angle = angle;
	bullet.x = bullet.fireX = x;
	bullet.y = bullet.fireY = y;
...
void CpSkil_Charge::fire(float x, float y, float angle, int plussize)
{
	...
	ZeroMemory(&bullet, sizeof(tagBullet));
	bullet.bulletImage = new  image;
	bullet.bulletImage = IMAGE->addImage("ÃæÀüÃÑ¾Ë", "images/bullet_bmp/PBullet_Charge.bmp", 50, 50, true);
	bullet.angle = angle;
	bullet.speed = 5.0f;
	bullet.x = bullet.fireX = x;
	bullet.y = bullet.fireY = y;
