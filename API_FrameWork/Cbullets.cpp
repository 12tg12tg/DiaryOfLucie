...
void CpSword::fire2(float x, float y, float angle, int plussize)
{
	...
	bullet.bulletImage2 = IMAGE->addImage("°Ë1", "images/bullet_bmp/sword1.bmp", 192, 192, true, RGB(255, 0, 255));
	bullet.angle = angle;
	bullet.rotateangle = angle + PI / 2;
	bullet.speed = 5.0f;
	bullet.x = bullet.fireX = x;
...
void CpSword::fire3(float x, float y, float angle, int plussize)
{
	...
	bullet.bulletImage3 = IMAGE->addImage("°Ë1", "images/bullet_bmp/sword1.bmp", 192, 192,true, RGB(255, 0, 255));
	bullet.angle = angle;
	bullet.rotateangle = angle + PI / 2;
	bullet.speed = 5.0f;
	bullet.x = bullet.fireX = x;
