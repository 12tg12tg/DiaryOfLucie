...
HRESULT Item::init()
{
	...
	item1.item_stat_Info = "체력+1,이동속도+0.2";
	item1.price = 80;
	...
	item2.item_name = "오발탄";
	item2.item_info = "오발탄...오발탄...5발탄";
	item2.item_shopInfo = "엄청난 유물이야 꼭 사는 것을 추천해";
	item2.item_stat_Info = "체력+2,공격력 30%증가";
	item2.price = 300;
	...
	item3.item_stat_Info = "체력+2,스킬공격+10";
	item3.price = 120;
	...
	item5.item_shopInfo = "훈련을 위해서 많이 쓰는 검이야 그런데 설마 이런거 쓰니..?";
	item5.item_stat_Info = "공격력+6,공격속도+2,스킬공격-2";
	item5.price = 60;
	...
	item6.item_info ="이상한 나라에서 온 소녀가 입던 옷 어째서인지 거미가 들러붙는다 ";
	item6.item_shopInfo = "고급스러운 디자인의 옷이야";
	item6.item_stat_Info = "체력+3,이동속도+0.2";
	item6.price = 200;
	...
	item7.item_info = "이상한 나라에서 온 소녀가 입던 신발 어째서인지 거미가 들러붙는다.";
	item7.item_shopInfo= " 고급스러운 디자인의 신발이야";
	item7.item_stat_Info= "공격력+3,공격속도+1,이동속도+0.2";
	item7.price = 200;
	...
	item8.item_info = "신성시 여겨지는 유물-의외로 상점에서 구입가능 ";
	item8.item_shopInfo="비밀스러운 방법으로 가져온 유물이야 살래?";
	item8.item_stat_Info="공격력 +10 , 공격속도 +2";
	item8.price = 200;
	...
	item9.item_info = "얼어붙어있는 투구이다 ";
	item9.item_shopInfo = "왕위에 계승할 느낌이 들어 'Succeeding you father'";
	item9.item_stat_Info = "체력+6,이동속도 -0.5";
	item9.price = 300;
	...
	item11.item_stat_Info = "체력 -3,공격 +30 ,공격속도 +3,스킬공격 -6";
	item11.price = 300;
	...
	item12.item_name = "냄뚜";
	item12.item_info = "나름 단단하다";
	item12.item_shopInfo = "집에서 쓰던 냄비뚜껑이야";
	item12.item_stat_Info = "체력+2";
	item12.price = 70;
	...
	item13.item_stat_Info ="공격력 +3, 공격속도 +1";
	item13.price = 60;
	...
	item14.item_stat_Info="체력+1,공격력 +9, 이동속도 +0.4";
	item14.price = 200;
	...
	item15.item_stat_Info = "마나+1,스킬공격 +1";
	item15.price = 60;
